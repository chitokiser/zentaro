...
export function WebzinePostView({
  ...
  // Already sanitized server-side (see sanitizePostHtml in the page component) before
  // reaching this "use client" component, so it's safe to render directly below.
