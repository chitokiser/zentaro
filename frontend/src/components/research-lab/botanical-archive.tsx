...
const botanicalData: Botanical[] = [
    ...
    },
    {
        ...
        nameKo: "제네피",
        nameEn: "Genepy",
        scientificName: "Artemisia genepi",
        flavorProfile: { top: "은은하고 알파인한 허브향", mid: "가벼운 쓴맛", base: "부드러운 여운" },
        flavorChart: chart(10, 15, 20, 45, 10),
        extraction: "냉침출 (Cold Maceration)",
        description: "알프스 고산지대에서 자라는 웜우드의 친척으로, 훨씬 순하고 향긋해 알파인 리큐르의 핵심 원료로 쓰입니다.",
        relatedProduct: "BANJJAC 리큐르",
    },
    {
        id: "yarrow",
        ...
        flavorProfile: { top: "쌉싸름하고 허브틱한 향", mid: "은은한 스파이시함", base: "긴 여운" },
        flavorChart: chart(10, 20, 15, 45, 5),
        extraction: "직접 침출 및 가열 (Maceration & Boiling)",
        description: "홉이 대중화되기 전 맥주 쓴맛의 근간이었던 '그루트' 허브 중 하나로, 쌉싸름하고 복합적인 향을 냅니다.",
        relatedProduct: "BANJJAC 리큐르",
    },
    {
        id: "meadowsweet",
        ...
        flavorProfile: { top: "달콤하고 아몬드를 닮은 향", mid: "은은한 꿀 뉘앙스", base: "부드러운 여운" },
        flavorChart: chart(10, 5, 55, 20, 35),
        extraction: "냉침출 (Cold Maceration)",
        description: "역시 전통 그루트 허브로, 아몬드와 꿀을 닮은 달콤한 향이 특징입니다.",
        relatedProduct: "ZENTARO Floral Gin",
    },
    {
        id: "heather",
        ...
        flavorProfile: { top: "은은하고 허니한 꽃향", mid: "가벼운 흙내음", base: "부드러운 여운" },
        flavorChart: chart(10, 5, 60, 30, 25),
        extraction: "냉침출 (Cold Maceration)",
        description: "스코틀랜드 황야를 뒤덮는 꽃으로, 헤더 에일에도 쓰이는 은은하고 허니한 꽃향을 냅니다.",
        relatedProduct: "ZENTARO Floral Gin",
    },
    {
        id: "sweet-woodruff",
        ...
        flavorProfile: { top: "갓 벤 건초를 닮은 향", mid: "은은한 바닐라 뉘앙스", base: "부드러운 여운" },
        flavorChart: chart(5, 5, 20, 35, 30),
        extraction: "냉침출 (Cold Maceration)",
        description: "독일 전통 '마이 와인'의 핵심 허브로, 말리면 갓 벤 건초 같은 쿠마린 향이 짙어집니다.",
        relatedProduct: "BANJJAC 리큐르",
    },
    {
        id: "horehound",
        ...
        flavorProfile: { top: "쌉싸름하고 허브틱한 향", mid: "은은한 흙내음", base: "긴 쓴맛 여운" },
        flavorChart: chart(5, 10, 10, 55, 10),
        extraction: "직접 침출 및 가열 (Maceration & Boiling)",
        description: "전통 기침 사탕의 원료로 익숙한 허브로, 쌉싸름한 맛이 비터스 계열 리큐르와 잘 어울립니다.",
        relatedProduct: "BANJJAC 리큐르",
    },
    {
        id: "devils-claw",
        ...
        flavorProfile: { top: "극도로 강렬한 쓴맛", mid: "은은한 흙내음", base: "긴 쓴맛 여운" },
        flavorChart: chart(5, 5, 5, 65, 5),
        extraction: "냉침출 (Cold Maceration)",
        description: "남아프리카산 뿌리로, 쓴맛이 매우 강렬해 극소량만 비터스의 뼈대로 사용합니다.",
        relatedProduct: "BANJJAC 리큐르",
    },
    {
        id: "damiana",
        ...
        flavorProfile: { top: "은은하고 허브틱한 향", mid: "가벼운 카모마일 뉘앙스", base: "부드러운 여운" },
        flavorChart: chart(10, 10, 30, 30, 15),
        extraction: "냉침출 (Cold Maceration)",
        description: "멕시코 전통 리큐르로 유명한 잎으로, 카모마일을 닮은 은은하고 허브틱한 향을 냅니다.",
        relatedProduct: "BANJJAC 리큐르",
    },
    {
        id: "guarana",
        ...
        flavorProfile: { top: "은은한 초콜릿·견과류향", mid: "가벼운 쓴맛", base: "긴 여운" },
        flavorChart: chart(5, 5, 5, 45, 20),
        extraction: "직접 침출 및 가열 (Maceration & Boiling)",
        description: "카페인 함량이 매우 높은 브라질 씨앗으로, 초콜릿과 견과류 사이의 독특한 향을 냅니다.",
        relatedProduct: "ZENTARO BLUE RESERVE",
    },
    {
        id: "kola-nut",
        ...
        flavorProfile: { top: "쌉싸름한 향", mid: "은은한 로스티함", base: "긴 여운" },
        flavorChart: chart(5, 10, 5, 50, 15),
        extraction: "직접 침출 및 가열 (Maceration & Boiling)",
        description: "초기 콜라 음료의 원료로 유명한 씨앗으로, 쌉싸름하고 로스티한 향을 냅니다.",
        relatedProduct: "ZENTARO BLUE RESERVE",
    },
    {
        id: "chinotto",
        nameKo: "키노토(머틀잎 오렌지)",
        nameEn: "Chinotto",
        scientificName: "Citrus myrtifolia",
        flavorProfile: { top: "쌉싸름한 시트러스향", mid: "은은한 캐러멜 뉘앙스", base: "긴 여운" },
        flavorChart: chart(65, 10, 10, 20, 15),
        extraction: "직접 침출 및 가열 (Maceration & Boiling)",
        description: "이탈리아 아마로·소다의 핵심 시트러스로, 다른 오렌지류보다 훨씬 쌉싸름한 개성을 냅니다.",
        relatedProduct: "BANJJAC 리큐르",
    },
    {
        id: "baobab-fruit",
        ...
        flavorProfile: { top: "새콤하고 은은한 과일향", mid: "가벼운 캐러멜 뉘앙스", base: "부드러운 여운" },
        flavorChart: chart(35, 5, 10, 20, 25),
        extraction: "냉침출 (Cold Maceration)",
        description: "아프리카 '생명의 나무' 열매로, 가루 형태로 새콤하고 은은한 향을 낸다고 알려져 있습니다.",
        relatedProduct: "ZENTARO Citrus Gin",
    },
    {
        id: "wild-cherry-bark",
        nameKo: "와일드 체리 나무껍질",
        nameEn: "Wild Cherry Bark",
        scientificName: "Prunus serotina",
        flavorProfile: { top: "은은한 아몬드·체리향", mid: "가벼운 우디함", base: "부드러운 여운" },
        flavorChart: chart(10, 5, 10, 40, 30),
        extraction: "직접 침출 및 가열 (Maceration & Boiling)",
        description: "전통 기침약 시럽에도 쓰인 껍질로, 아몬드와 체리 사이의 은은한 향을 냅니다.",
        relatedProduct: "ZENTARO Whisky",
    },
    {
        id: "nepal-black-cardamom",
        nameKo: "네팔 블랙 카다멈",
        nameEn: "Nepal Black Cardamom",
        scientificName: "Amomum subulatum",
        flavorProfile: { top: "스모키하고 강렬한 향", mid: "은은한 장뇌 뉘앙스", base: "긴 여운" },
        flavorChart: chart(5, 70, 5, 55, 5),
        extraction: "직접 침출 및 가열 (Maceration & Boiling)",
        description: "베트남산 초과(Tsaoko)와는 다른 종으로, 네팔·인도산 훈연 건조 카다멈입니다.",
        relatedProduct: "ZENTARO Blue Dry Gin",
    },
    {
        id: "aloe-ferox",
        ...
        flavorChart: chart(5, 5, 5, 60, 5),
        extraction: "냉침출 (Cold Maceration)",
        description: "남아프리카산 알로에로, 세계에서 가장 쓴 식물성 원료 중 하나로 꼽혀 극소량만 사용합니다.",
        relatedProduct: "BANJJAC 리큐르",
    },
    {
        id: "sweet-cicely",
        ...
        flavorProfile: { top: "아니스를 닮은 달콤한 향", mid: "은은한 그린 노트", base: "부드러운 여운" },
        flavorChart: chart(10, 25, 15, 20, 30),
        extraction: "증기 주입법 (Vapor Infusion)",
        description: "잎과 씨앗 모두 아니스를 닮은 달콤한 향을 지녀, 설탕을 줄이고 싶을 때 자연스러운 단맛을 더합니다.",
        relatedProduct: "ZENTARO Original Dry Gin",
    },
    {
        id: "alexanders",
        ...
        flavorProfile: { top: "셀러리를 닮은 향", mid: "은은한 몰약 뉘앙스", base: "가벼운 여운" },
        flavorChart: chart(10, 20, 10, 35, 5),
        extraction: "증기 주입법 (Vapor Infusion)",
        description: "안젤리카의 친척뻘 허브로, 셀러리와 몰약 사이의 독특한 향을 지녀 로마 시대부터 쓰였습니다.",
        relatedProduct: "ZENTARO Original Dry Gin",
    },
    {
        id: "wild-carrot-seed",
        nameKo: "와일드 캐럿씨(퀸 앤스 레이스)",
        nameEn: "Wild Carrot Seed",
        scientificName: "Daucus carota",
        flavorProfile: { top: "은은한 당근·꽃향", mid: "가벼운 흙내음", base: "부드러운 여운" },
        flavorChart: chart(10, 15, 30, 30, 10),
        extraction: "직접 침출 및 가열 (Maceration & Boiling)",
    ...
    return (
        <div className="min-h-screen bg-slate-900 px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-4xl text-center">
                ...
                <div className="mt-4 inline-flex items-center gap-1.5 rounded-full border border-amber-500/30 bg-amber-500/10 px-4 py-1.5 text-xs font-medium text-amber-400">
                    <FlaskConical className="h-3.5 w-3.5" />
                    직접 실험을 통해 확보한 데이터
                </div>
                <p className="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-slate-400 sm:text-base">
                    젠타로 증류소의 비밀 실험실에서 직접 실험을 통해 확보한 보태니컬 원료 {botanicalData.length}종의 향미 구조와
                    추출 비법을 기록합니다. 카드를 눌러 자세히 탐구하거나, 원 모양 버튼으로 여러 원료를 골라 믹스 결과를 미리 볼 수
                    있습니다.
                </p>
            </div>
