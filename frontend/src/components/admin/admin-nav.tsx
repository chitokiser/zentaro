...
const ADMIN_SECTIONS: AdminSection[] = [
  ...
  { label: "EXP/ZP 발행 현황", href: "/admin/transactions", requiredLevel: 1 },
  { label: "오크배럴 관리", href: "/admin/barrels", requiredLevel: 2 },
  ...
  { label: "Ztaro 리워드 QR", href: "/admin/ztro-rewards", requiredLevel: 2 },
  { label: "ZTARO 결제 할인율", href: "/admin/ztaro-discount", requiredLevel: 1 },
