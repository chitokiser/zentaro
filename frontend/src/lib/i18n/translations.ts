...
const ko = {
  nav: {
    ...
    serviceItems: {
      ...
      botanicalLibraryDesc: "보태니컬 데이터베이스 & AI 향미 예측 랩",
    },
    ...
    drinksItems: {
      explore: "둘러보기",
      exploreDesc: "전 세계 술·음료 검색",
      spirits: "Spirits",
      spiritsDesc: "위스키·진·보드카·럼 등",
      wine: "Wine",
      wineDesc: "와인",
      beer: "Beer",
      beerDesc: "맥주",
      cocktails: "Cocktails",
      cocktailsDesc: "칵테일 레시피",
      botanicals: "Botanicals",
      botanicalsDesc: "허브·향신료·보태니컬",
      rankings: "Rankings",
      rankingsDesc: "랭킹",
    },
  },
  drinks: {
    title: "ZENTARO GLOBAL DRINKS",
    subtitle: "전 세계 술·증류주·원료·향미를 발견하세요",
    searchPlaceholder: "술, 브랜드, 원료, 보태니컬 또는 국가로 검색...",
    rankingsLink: "랭킹",
    botanicalsLink: "보태니컬",
    statisticsLink: "통계",
  },
  ...
  webzine: {
    ...
    memberOnlyTitle: "회원 전용 콘텐츠입니다",
    memberOnlyDescription: "웹진 상세 내용은 회원만 볼 수 있습니다. 계정이 없으시다면 먼저 회원가입을 해주세요.",
  ...
  bottleCap: {
    ...
    loginRequired: "로그인이 필요합니다.",
    loginCta: "로그인 하러가기",
    qrCodeLoginPrompt: "이 QR 코드로 Ztaro 리워드를 받으려면 먼저 회원가입 또는 로그인이 필요합니다. 가입/로그인 후 자동으로 이어서 리워드를 받으실 수 있습니다.",
    qrCodeLoginCta: "회원가입/로그인하고 계속하기",
  ...
  myPage: {
    ...
    profile: {
      ...
      saving: "저장 중...",
      saveShipping: "배송지 저장",
      loginPasswordTitle: "로그인 비밀번호 설정",
      loginPasswordDescriptionSet: "구글 로그인을 사용할 수 없는 상황(인앱 브라우저 등)을 대비해, 이메일+비밀번호로도 로그인할 수 있도록 비밀번호를 새로 설정할 수 있습니다.",
      loginPasswordDescriptionHas: "이메일+비밀번호 로그인이 이미 설정되어 있습니다. 아래에서 비밀번호를 변경할 수 있습니다.",
      newPasswordPlaceholder: "새 비밀번호 (8자 이상)",
      confirmPasswordPlaceholder: "새 비밀번호 확인",
      passwordMismatchError: "비밀번호가 서로 일치하지 않습니다.",
    ...
    wallet: {
      ...
      transferSectionTitle: "회원에게 ZP 보내기 (수수료 3%)",
      transferSectionDescription: "다른 ZENTARO 회원에게 ZP를 직접 보낼 수 있습니다. 전송 시 3% 수수료가 차감된 금액이 상대방에게 지급됩니다.",
      transferEmailLabel: "받는 회원 이메일 *",
      transferEmailPlaceholder: "member@email.com",
      transferAmountLabel: "보낼 ZP 수량 *",
      transferEstimateLabel: "상대방 수령 예상액 (수수료 3% 차감 후):",
      transferButton: "ZP 보내기",
      transferSending: "전송 중...",
      transferSuccessMiddle: " ZP를 보내 상대방이 ",
      transferSuccessSuffix: " ZP를 수령했습니다.",
      transferErrorGeneric: "ZP 송금 중 오류가 발생했습니다.",
      transferMinAlert: "최소 1,000 ZP 이상부터 송금이 가능합니다.",
      transferInsufficientAlert: "보유 ZP보다 많이 보낼 수 없습니다.",
      transferEmailRequiredAlert: "받는 회원의 이메일을 입력해주세요.",
  ...
  company: {
    ...
    ceoMessage: {
      quote: "좋은 술의 가치는 서두름이 아닌, 시간과 정성 속에서 완성됩니다.",
      greeting1: "안녕하십니까.",
      greeting2: "ZENTARO를 찾아주신 모든 분들께 진심으로 감사드립니다.",
      intro: [
        "ZENTARO는 베트남의 PHÚC LỘC 증류소에서 시작된 프리미엄 크래프트 스피릿 브랜드입니다.",
        "우리는 빠른 속도와 효율을 중요하게 생각하는 시대를 살아가고 있습니다. 하지만 좋은 술의 가치는 결코 서두름만으로 만들어지지 않는다고 믿습니다.",
        "좋은 원료를 선택하고, 정성을 다해 준비하며, 시간을 기다리고, 끊임없이 연구하는 과정.",
        "그 모든 시간이 한 잔의 술에 깊이와 품격을 만들어 줍니다.",
        "이것이 바로 ZENTARO가 시작된 이유입니다.",
      ],
      sections: [
        {
          heading: "ZEN & TARO",
          paragraphs: [
            "ZENTARO라는 이름에는 우리가 추구하는 철학이 담겨 있습니다.",
            "ZEN은 Balance, Craftsmanship, Restraint를 의미합니다.",
            "균형을 이루고, 장인정신을 담으며, 불필요한 것을 덜어내는 절제.",
            "우리는 좋은 술이란 많은 것을 더하는 것이 아니라, 좋은 것을 선택하고 본질을 끝까지 지켜내는 것이라고 생각합니다.",
            "TARO는 Taste, Aroma, Refined, Origin을 의미합니다.",
            "맛과 향의 완성도, 세련된 품질, 그리고 원료와 그 원산지에 대한 진정성.",
            "ZENTARO는 이 네 가지 가치를 통해 베트남의 고유한 원료와 풍토를 세계적인 스피릿으로 표현하고자 합니다.",
          ],
        },
        {
          heading: "From Vietnam, To the World",
          paragraphs: [
            "베트남은 풍부한 농업 자원과 독특한 자연환경을 가진 나라입니다.",
            "특히 베트남 쌀은 ZENTARO의 가장 중요한 출발점입니다.",
            "우리는 좋은 쌀을 단순한 원료로 바라보지 않습니다.",
            "쌀이 가진 섬세한 향과 질감, 발효 과정에서 만들어지는 풍미, 그리고 증류를 통해 변화하는 향을 연구하며 베트남 쌀이 가진 새로운 가능성을 발견하고자 합니다.",
            "또한 레몬그라스, 고수씨, 후추, 진피 등 베트남과 동남아시아의 다양한 식물과 허브를 연구하여, 지역의 개성을 담은 새로운 크래프트 스피릿을 만들어가고 있습니다.",
            "우리의 목표는 베트남의 원료를 세계가 경험할 수 있는 술로 만드는 것입니다.",
          ],
        },
        {
          heading: "Spirit Research & Craftsmanship",
          paragraphs: [
            "ZENTARO는 단순한 주류 브랜드가 아닙니다.",
            "우리는 증류와 발효를 연구하는 크래프트 스피릿 브랜드를 지향합니다.",
            "전통적인 증류 기술을 존중하면서도 현대적인 설비와 과학적인 연구 방법을 접목하고, 원료·발효·증류·숙성·블렌딩의 모든 과정에서 더 나은 방법을 끊임없이 찾아가고 있습니다.",
            "때로는 하나의 향을 찾기 위해 수십 번의 실험을 반복하고, 작은 차이를 확인하기 위해 한 잔의 술을 수없이 비교합니다.",
            "그 작은 차이가 결국 한 병의 품질을 결정한다고 믿기 때문입니다.",
          ],
        },
        {
          heading: "우리가 만들고 싶은 것",
          paragraphs: [
            "우리는 단순히 술을 판매하는 기업이 되고 싶지 않습니다.",
            "한 잔의 술을 통해 사람과 사람이 만나고, 서로의 이야기를 나누며, 술이 만들어지는 과정과 그 안에 담긴 장인정신을 경험할 수 있는 문화를 만들고 싶습니다.",
            "비록 작은 증류소에서 시작했지만 우리의 꿈은 작지 않습니다.",
            "ZENTARO는 앞으로 동남아시아를 대표하는 크래프트 스피릿 연구소이자 증류 문화 공간으로 성장하고자 합니다.",
            "누구나 좋은 원료를 직접 보고, 증류 과정을 경험하고, 자신만의 술을 연구하고 만들어볼 수 있는 공간.",
            "그리고 베트남의 원료와 장인정신을 세계와 연결하는 브랜드.",
            "그것이 우리가 그리고 있는 ZENTARO의 미래입니다.",
          ],
        },
      ],
      promise: {
        intro: "우리에게 술은 단순한 음료가 아닙니다.",
        poem: [
          "한 병에는 시간과 정성이 담겨 있고,",
          "한 잔에는 사람의 이야기가 담겨 있으며,",
          "함께하는 순간에는 삶의 여유가 담겨 있습니다.",
        ],
        leadIn: "ZENTARO는 앞으로도",
        principles: ["정직한 원료", "투명한 제조 과정", "타협하지 않는 품질", "끊임없는 연구와 혁신"],
        afterPrinciples: "을 가장 중요한 원칙으로 삼겠습니다.",
        vietnamToWorld: "베트남에서 시작하지만 세계를 향하겠습니다.",
        closingPoem: [
          "그리고 시간이 흐를수록 더욱 깊어지는 향처럼,",
          "ZENTARO 역시 시간이 지날수록 가치가 깊어지는 브랜드가 되겠습니다.",
        ],
      },
      finalThanks: "ZENTARO를 찾아주신 모든 분들께 다시 한번 감사드립니다.",
      signature: {
        company: "PHÚC LỘC DISTILLERY",
        brand: "ZENTARO",
        title: "대표이사",
        name: "NGUYỄN XUÂN ƯỚC",
      },
    },
  },
};
...
const en: Dict = {
  nav: {
    ...
    serviceItems: {
      ...
      botanicalLibrary: "Botanical Library",
      botanicalLibraryDesc: "Botanical database & AI flavor prediction lab",
    },
    myPage: { label: "My Page" },
    myPageItems: {
      profile: "Profile",
    ...
    drinksItems: {
      explore: "Explore",
      exploreDesc: "Search drinks worldwide",
      spirits: "Spirits",
      spiritsDesc: "Whisky, gin, vodka, rum & more",
      wine: "Wine",
      wineDesc: "Wine",
      beer: "Beer",
      beerDesc: "Beer",
      cocktails: "Cocktails",
      cocktailsDesc: "Cocktail recipes",
      botanicals: "Botanicals",
      botanicalsDesc: "Herbs, spices & botanicals",
      rankings: "Rankings",
      rankingsDesc: "Rankings",
    },
  },
  drinks: {
    title: "ZENTARO GLOBAL DRINKS",
    subtitle: "Discover Drinks, Spirits, Ingredients & Flavors From Around the World",
    searchPlaceholder: "Search drinks, spirits, brands, ingredients, botanicals or countries...",
    rankingsLink: "Rankings",
    botanicalsLink: "Botanicals",
  ...
  webzine: {
    ...
    memberOnlyDescription: "The full article is for members only. If you don't have an account yet, please sign up first.",
    loginRequired: "Login required.",
    loginCta: "Sign up / Log in",
  ...
  bottleCap: {
    ...
    qrCodeLoginPrompt: "Sign up or log in to claim the Ztaro reward for this QR code. You'll automatically continue to claim it right after.",
    qrCodeLoginCta: "Sign up / log in to continue",
  ...
  myPage: {
    ...
    profile: {
      ...
      logout: "Log Out",
      switchAccount: "Log in with a different account",
      loginTab: "Log In",
      registerTab: "Sign Up",
      ...
      loginPasswordTitle: "Set Login Password",
      loginPasswordDescriptionSet: "In case Google sign-in isn't available to you (e.g. in-app browsers), you can set a password so you can also log in with your email.",
      loginPasswordDescriptionHas: "Email + password login is already set up. You can change your password below.",
    ...
    wallet: {
      ...
      transferSectionTitle: "Send ZP to a Member (3% fee)",
      transferSectionDescription: "Send ZP directly to another ZENTARO member. A 3% fee is withheld — the recipient gets the amount after fee.",
      transferEmailLabel: "Recipient's email *",
      transferEmailPlaceholder: "member@email.com",
      transferAmountLabel: "ZP amount to send *",
      transferEstimateLabel: "Recipient receives (after 3% fee):",
      transferButton: "Send ZP",
      transferSending: "Sending...",
      transferSuccessMiddle: " ZP sent — recipient received ",
      transferSuccessSuffix: " ZP.",
      transferErrorGeneric: "Something went wrong while sending ZP.",
      transferMinAlert: "You can send a minimum of 1,000 ZP.",
      transferInsufficientAlert: "You cannot send more than your ZP balance.",
      transferEmailRequiredAlert: "Please enter the recipient's email.",
  ...
  company: {
    ...
    ceoMessage: {
      quote: "The value of a good spirit is completed not by haste, but by time and dedication.",
      greeting1: "Greetings.",
      greeting2: "We sincerely thank everyone who has visited ZENTARO.",
      intro: [
        "ZENTARO is a premium craft spirits brand born at PHÚC LỘC Distillery in Vietnam.",
        "We live in an age that prizes speed and efficiency. Yet we believe the value of a good spirit is never made by haste alone.",
        "Choosing good ingredients, preparing them with care, waiting for time to do its work, and researching without end.",
        "All of that time is what gives a single glass its depth and character.",
        "This is the very reason ZENTARO began.",
      ],
      sections: [
        {
          heading: "ZEN & TARO",
          paragraphs: [
            "The name ZENTARO carries the philosophy we pursue.",
            "ZEN stands for Balance, Craftsmanship, and Restraint.",
            "Finding balance, embodying craftsmanship, and the restraint of paring away the unnecessary.",
            "We believe a good spirit isn't made by adding more, but by choosing what's good and holding fast to its essence.",
            "TARO stands for Taste, Aroma, Refined, and Origin.",
            "The completeness of taste and aroma, refined quality, and authenticity toward the ingredients and their origin.",
            "Through these four values, ZENTARO seeks to express Vietnam's own ingredients and terroir as a world-class spirit.",
          ],
        },
        {
          heading: "From Vietnam, To the World",
          paragraphs: [
            "Vietnam is a country of rich agricultural resources and a distinctive natural environment.",
            "Vietnamese rice, in particular, is ZENTARO's most important starting point.",
            "We do not see good rice as a mere ingredient.",
            "We study the delicate aroma and texture rice carries, the flavor born through fermentation, and the way its aroma transforms through distillation, seeking to discover the new possibilities within Vietnamese rice.",
            "We also study lemongrass, coriander seed, pepper, dried citrus peel, and other plants and herbs native to Vietnam and Southeast Asia, crafting new craft spirits that carry the character of the region.",
            "Our goal is to turn Vietnam's ingredients into a spirit the world can experience.",
          ],
        },
        {
          heading: "Spirit Research & Craftsmanship",
          paragraphs: [
            "ZENTARO is not simply a spirits brand.",
            "We aspire to be a craft spirits brand devoted to researching distillation and fermentation.",
            "While honoring traditional distillation techniques, we bring in modern equipment and scientific research methods, constantly searching for a better way at every stage — ingredients, fermentation, distillation, aging, and blending.",
            "Sometimes we repeat an experiment dozens of times in search of a single aroma, and compare a glass of spirit countless times just to confirm the smallest difference.",
            "Because we believe that small difference is what ultimately decides the quality of a single bottle.",
          ],
        },
        {
          heading: "What We Want to Build",
          paragraphs: [
            "We don't want to be a company that simply sells spirits.",
            "We want to build a culture where, through a single glass, people meet people, share their stories, and experience the process behind a spirit and the craftsmanship held within it.",
            "Though we started at a small distillery, our dream is not small.",
            "ZENTARO aspires to grow into a craft spirits research institute and a distillation culture space representing Southeast Asia.",
            "A space where anyone can see good ingredients firsthand, experience the distillation process, and research and craft a spirit of their own.",
            "And a brand that connects Vietnam's ingredients and craftsmanship with the world.",
            "That is the future we envision for ZENTARO.",
          ],
        },
      ],
      promise: {
        intro: "To us, a spirit is not merely a drink.",
        poem: [
          "A bottle holds time and dedication,",
          "a glass holds a person's story,",
          "and a shared moment holds the ease of life.",
        ],
        leadIn: "Going forward, ZENTARO will continue to hold",
        principles: ["honest ingredients", "a transparent manufacturing process", "uncompromising quality", "relentless research and innovation"],
        afterPrinciples: "as our most important principles.",
        vietnamToWorld: "We begin in Vietnam, but we look toward the world.",
        closingPoem: [
          "And like an aroma that deepens the longer it rests,",
          "ZENTARO too will become a brand whose value deepens with time.",
        ],
      },
      finalThanks: "Once again, our sincere thanks to everyone who has visited ZENTARO.",
      signature: {
        company: "PHÚC LỘC DISTILLERY",
        brand: "ZENTARO",
        title: "Director",
...
const vi: Dict = {
  nav: {
    ...
    serviceItems: {
      ...
      botanicalLibrary: "Botanical Library",
      botanicalLibraryDesc: "Cơ sở dữ liệu thực vật & phòng lab dự đoán hương vị AI",
    },
    ...
    drinksItems: {
      explore: "Khám phá",
      exploreDesc: "Tìm kiếm đồ uống toàn cầu",
      spirits: "Spirits",
      spiritsDesc: "Whisky, gin, vodka, rum...",
      wine: "Wine",
      wineDesc: "Rượu vang",
      beer: "Beer",
      beerDesc: "Bia",
      cocktails: "Cocktails",
      cocktailsDesc: "Công thức cocktail",
      botanicals: "Botanicals",
      botanicalsDesc: "Thảo mộc, gia vị & botanical",
      rankings: "Rankings",
      rankingsDesc: "Bảng xếp hạng",
    },
  },
  drinks: {
    title: "ZENTARO GLOBAL DRINKS",
    subtitle: "Khám phá đồ uống, rượu mạnh, nguyên liệu và hương vị từ khắp thế giới",
    searchPlaceholder: "Tìm kiếm đồ uống, thương hiệu, nguyên liệu, botanical hoặc quốc gia...",
    rankingsLink: "Rankings",
    botanicalsLink: "Botanicals",
    statisticsLink: "Thống kê",
  },
  daoStakingPage: {
  ...
  webzine: {
    ...
    memberOnlyTitle: "Nội dung dành riêng cho hội viên",
    memberOnlyDescription: "Bài viết đầy đủ chỉ dành cho hội viên. Nếu bạn chưa có tài khoản, vui lòng đăng ký trước.",
    loginRequired: "Cần đăng nhập.",
    loginCta: "Đăng ký / Đăng nhập",
  ...
  bottleCap: {
    ...
    qrCodeLoginPrompt: "Vui lòng đăng ký hoặc đăng nhập để nhận thưởng Ztaro cho mã QR này. Bạn sẽ tự động tiếp tục nhận thưởng ngay sau đó.",
    qrCodeLoginCta: "Đăng ký / đăng nhập để tiếp tục",
  ...
  myPage: {
    ...
    profile: {
      ...
      loginPasswordTitle: "Đặt mật khẩu đăng nhập",
      loginPasswordDescriptionSet: "Phòng khi không thể đăng nhập bằng Google (ví dụ: trình duyệt trong ứng dụng), bạn có thể đặt mật khẩu để đăng nhập bằng email.",
      loginPasswordDescriptionHas: "Bạn đã thiết lập đăng nhập bằng email + mật khẩu. Bạn có thể đổi mật khẩu bên dưới.",
      newPasswordPlaceholder: "Mật khẩu mới (từ 8 ký tự)",
    ...
    wallet: {
      ...
      transferSectionTitle: "Gửi ZP cho hội viên khác (phí 3%)",
      transferSectionDescription: "Bạn có thể gửi trực tiếp ZP cho hội viên ZENTARO khác. Phí 3% sẽ bị trừ — người nhận sẽ nhận được số tiền sau khi trừ phí.",
      transferEmailLabel: "Email hội viên nhận *",
      transferEmailPlaceholder: "member@email.com",
      transferAmountLabel: "Số ZP muốn gửi *",
      transferEstimateLabel: "Người nhận sẽ nhận được (sau khi trừ phí 3%):",
      transferButton: "Gửi ZP",
      transferSending: "Đang gửi...",
      transferSuccessMiddle: " ZP đã gửi — người nhận đã nhận ",
      transferSuccessSuffix: " ZP.",
      transferErrorGeneric: "Đã xảy ra lỗi khi gửi ZP.",
      transferMinAlert: "Số ZP gửi tối thiểu là 1.000 ZP.",
      transferInsufficientAlert: "Không thể gửi nhiều hơn số ZP đang có.",
      transferEmailRequiredAlert: "Vui lòng nhập email của người nhận.",
  ...
  company: {
    ...
    ceoMessage: {
      quote: "Giá trị của một loại rượu ngon không đến từ sự vội vàng, mà được hoàn thiện qua thời gian và sự tận tâm.",
      greeting1: "Xin chào.",
      greeting2: "Chúng tôi chân thành cảm ơn tất cả những ai đã ghé thăm ZENTARO.",
      intro: [
        "ZENTARO là thương hiệu rượu thủ công cao cấp khởi nguồn từ Nhà máy Rượu PHÚC LỘC tại Việt Nam.",
        "Chúng ta đang sống trong thời đại coi trọng tốc độ và hiệu quả. Nhưng chúng tôi tin rằng giá trị của một loại rượu ngon không bao giờ được tạo nên chỉ bằng sự vội vàng.",
        "Chọn lựa nguyên liệu tốt, chuẩn bị tận tâm, kiên nhẫn chờ đợi thời gian, và không ngừng nghiên cứu.",
        "Tất cả khoảng thời gian đó tạo nên chiều sâu và đẳng cấp cho một ly rượu.",
        "Đó chính là lý do ZENTARO ra đời.",
      ],
      sections: [
        {
          heading: "ZEN & TARO",
          paragraphs: [
            "Cái tên ZENTARO chứa đựng triết lý mà chúng tôi theo đuổi.",
            "ZEN đại diện cho Sự cân bằng (Balance), Tay nghề thủ công (Craftsmanship) và Sự kiềm chế (Restraint).",
            "Đạt được sự cân bằng, gìn giữ tinh thần thủ công, và sự kiềm chế loại bỏ những điều không cần thiết.",
            "Chúng tôi tin rằng một loại rượu ngon không phải là thêm vào thật nhiều thứ, mà là chọn lựa những gì tốt nhất và giữ vững bản chất đến cùng.",
            "TARO là viết tắt của Taste (Vị), Aroma (Hương), Refined (Tinh tế) và Origin (Nguồn gốc).",
            "Sự hoàn thiện của vị và hương, chất lượng tinh tế, và sự chân thực đối với nguyên liệu cùng nguồn gốc của nó.",
            "Thông qua bốn giá trị này, ZENTARO mong muốn thể hiện nguyên liệu và thổ nhưỡng đặc trưng của Việt Nam thành một loại rượu tầm cỡ thế giới.",
          ],
        },
        {
          heading: "From Vietnam, To the World",
          paragraphs: [
            "Việt Nam là đất nước có nguồn tài nguyên nông nghiệp phong phú và môi trường tự nhiên độc đáo.",
            "Đặc biệt, gạo Việt Nam chính là điểm khởi đầu quan trọng nhất của ZENTARO.",
            "Chúng tôi không xem gạo ngon chỉ đơn thuần là một nguyên liệu.",
            "Chúng tôi nghiên cứu hương thơm và kết cấu tinh tế của gạo, hương vị được tạo ra trong quá trình lên men, và sự biến đổi hương thơm qua chưng cất, để khám phá những khả năng mới của gạo Việt Nam.",
            "Chúng tôi cũng nghiên cứu sả, hạt ngò, tiêu, vỏ quýt khô và nhiều loại thảo mộc, thực vật đặc trưng của Việt Nam và Đông Nam Á, để tạo nên những dòng rượu thủ công mới mang đậm bản sắc vùng miền.",
            "Mục tiêu của chúng tôi là biến nguyên liệu Việt Nam thành loại rượu mà cả thế giới có thể trải nghiệm.",
          ],
        },
        {
          heading: "Spirit Research & Craftsmanship",
          paragraphs: [
            "ZENTARO không chỉ đơn thuần là một thương hiệu rượu.",
            "Chúng tôi hướng đến trở thành thương hiệu rượu thủ công chuyên nghiên cứu về chưng cất và lên men.",
            "Trong khi tôn trọng kỹ thuật chưng cất truyền thống, chúng tôi kết hợp thiết bị hiện đại và phương pháp nghiên cứu khoa học, không ngừng tìm kiếm phương pháp tốt hơn ở mọi công đoạn — nguyên liệu, lên men, chưng cất, ủ và pha chế.",
            "Đôi khi chúng tôi lặp lại một thí nghiệm hàng chục lần chỉ để tìm ra một hương thơm, và so sánh một ly rượu vô số lần chỉ để xác nhận một khác biệt nhỏ.",
            "Bởi chúng tôi tin rằng chính sự khác biệt nhỏ đó sẽ quyết định chất lượng của cả một chai rượu.",
          ],
        },
        {
          heading: "Điều chúng tôi muốn tạo nên",
          paragraphs: [
            "Chúng tôi không muốn chỉ là một doanh nghiệp bán rượu đơn thuần.",
            "Chúng tôi muốn tạo nên một nền văn hóa nơi con người gặp gỡ nhau, chia sẻ câu chuyện của nhau, và trải nghiệm quy trình tạo nên một loại rượu cùng tinh thần thủ công chứa đựng trong đó, thông qua một ly rượu.",
            "Dù khởi đầu từ một nhà máy rượu nhỏ, nhưng giấc mơ của chúng tôi không hề nhỏ.",
            "ZENTARO mong muốn phát triển thành viện nghiên cứu rượu thủ công và không gian văn hóa chưng cất tiêu biểu của Đông Nam Á.",
            "Một không gian nơi bất kỳ ai cũng có thể tận mắt xem nguyên liệu tốt, trải nghiệm quy trình chưng cất, và tự nghiên cứu, tạo nên loại rượu của riêng mình.",
            "Và một thương hiệu kết nối nguyên liệu cùng tinh thần thủ công của Việt Nam với thế giới.",
            "Đó chính là tương lai mà chúng tôi đang hướng tới cho ZENTARO.",
          ],
        },
      ],
      promise: {
        intro: "Đối với chúng tôi, rượu không chỉ đơn thuần là một loại đồ uống.",
        poem: [
          "Một chai rượu chứa đựng thời gian và sự tận tâm,",
          "một ly rượu chứa đựng câu chuyện của một con người,",
          "và mỗi khoảnh khắc sẻ chia chứa đựng sự thư thái của cuộc sống.",
        ],
        leadIn: "Trong tương lai, ZENTARO sẽ luôn xem",
        principles: ["nguyên liệu trung thực", "quy trình sản xuất minh bạch", "chất lượng không thỏa hiệp", "nghiên cứu và đổi mới không ngừng"],
        afterPrinciples: "là những nguyên tắc quan trọng nhất của mình.",
        vietnamToWorld: "Chúng tôi khởi đầu từ Việt Nam, nhưng hướng đến cả thế giới.",
        closingPoem: [
          "Và giống như hương thơm càng trở nên sâu lắng theo thời gian,",
          "ZENTARO cũng sẽ trở thành thương hiệu mà giá trị càng sâu sắc hơn theo năm tháng.",
        ],
      },
      finalThanks: "Một lần nữa, xin chân thành cảm ơn tất cả những ai đã ghé thăm ZENTARO.",
      signature: {
        company: "PHÚC LỘC DISTILLERY",
        brand: "ZENTARO",
        title: "Giám đốc",
