...
const ko = {
  ...
  webzine: {
    ...
    memberOnlyDescription: "웹진 상세 내용은 로그인 후 확인하실 수 있습니다.",
...
const en: Dict = {
  ...
  webzine: {
    ...
    memberOnlyDescription: "Log in to read the full webzine article.",
...
const vi: Dict = {
  ...
  webzine: {
    ...
    memberOnlyDescription: "Vui lòng đăng nhập để xem toàn bộ bài viết.",
